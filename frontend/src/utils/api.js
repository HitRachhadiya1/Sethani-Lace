...
const BASE_URL =
  import.meta.env.VITE_API_URL || "https://sethani-lace.onrender.com/api";
const USER_BASE_URL = import.meta.env.VITE_USER_API_URL || `${BASE_URL}/user`;
const PRODUCT_BASE_URL =
  import.meta.env.VITE_PRODUCT_API_URL || `${BASE_URL}/product`;
const ORDER_BASE_URL =
  import.meta.env.VITE_ORDER_API_URL || `${BASE_URL}/order`;
